...
theme.xbackground = '#292444'
theme.xforeground = '#cfdbf2'
theme.xcolor0     = '#292444'
theme.xcolor1     = '#77ADF4'
theme.xcolor2     = '#AB92AB'
theme.xcolor3     = '#8DB4F6'
theme.xcolor4     = '#A9A0E1'
theme.xcolor5     = '#CFA4E2'
theme.xcolor6     = '#97C3F7'
theme.xcolor7     = '#cfdbf2'
theme.xcolor8     = '#9099a9'
...
theme.wallpaper = theme.config_path.."/wallpapers/rooftop.jpg"
