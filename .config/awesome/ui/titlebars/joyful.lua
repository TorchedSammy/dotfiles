...
client.connect_signal('request::titlebars', function(c)
	...
	local close = titlebarbtn(c, beautiful.xcolor4, beautiful.xcolor8 .. 55, gears.shape.circle)
	close:connect_signal('button::press', function()
		c:kill()
	end)

	local minimize = titlebarbtn(c, beautiful.xcolor5, beautiful.xcolor8 .. 55, gears.shape.circle)
	minimize:connect_signal('button::press', function()
		c.minimized = true
	end)

	local maximize = titlebarbtn(c, beautiful.xcolor6, beautiful.xcolor8 .. 55, gears.shape.circle)
